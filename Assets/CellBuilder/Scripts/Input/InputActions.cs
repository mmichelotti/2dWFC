...
//     version 1.9.0
//     from Assets/CellBuilder/RoadInputAction.inputactions
//
...
public partial class @RoadInputAction: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @RoadInputAction()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""RoadInputAction"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@RoadInputAction()
    {
        Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, RoadInputAction.Player.Disable() has not been called.");
    }
    ...
    {
        private @RoadInputAction m_Wrapper;
        public PlayerActions(@RoadInputAction wrapper) { m_Wrapper = wrapper; }
